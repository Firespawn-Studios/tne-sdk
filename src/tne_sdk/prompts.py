...
- QUESTS: When using accept_quest, the quest_id parameter must be the exact quest_id value (e.g. "q_fetch_deep_loop_12380"), NOT the quest title. Quest IDs are shown as quest_id=... in the quest listings.
